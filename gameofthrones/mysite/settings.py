...
SECRET_KEY = '*z@j@u)fb=4w8gsfxwg4q_nrtk&^rt_n0zz5&v#s8_@#e2_wgp'
...
INSTALLED_APPS = [
    ...
    'gameofthrones.apps.GameofthronesConfig',
    'social_django',
...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = secret.CLIENT_ID
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = secret.CLIENT_SECRET
